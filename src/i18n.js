...
const DICT = {
  zh: {
    ...
    'DINGHAO DH3': '鼎好DH3 · 中关村',
    'Zhongguancun marble, glass lifts and a six-floor atrium': '中关村大理石大堂、玻璃电梯与六层中庭',
    'Dinghao DH3 Block B - lobby and lifts adapted for play': '鼎好DH3 B座 · 大堂与电梯经对战适配',
    'Zhongguancun Dinghao DH3 Block B - six floors, lifts and an atrium': '中关村鼎好DH3 B座 · 六层、电梯与中庭',
    'Zhongguancun': '中关村',
    'PLAZA': '广场',
    'NORTH STREET': '北街',
    'WEST MARKET': '西侧电子城',
    ...
    'FALL DAMAGE': '坠落伤害',
    'drop from anywhere · only the page edge hurts': '从哪掉都没事 · 只有掉出纸外会受伤',
    'a long drop hurts · glass and atriums matter': '高处坠落会受伤 · 玻璃和中庭变得危险',
    'fall damage': '坠落伤害',
    'Summer Palace': '颐和园',
    ...
    'open chat': '打开聊天',
    'teammates / everyone': '队友 / 全局',
    'TEAM': '队友',
    'ALL': '全局',
    'to teammates': '发给队友',
    'to everyone': '发给所有人',
    'Tab: teammates / everyone': 'Tab：队友 / 全局',
    'Enter · chat': '回车 · 聊天',
    'tap to chat': '点这里聊天',
    ...
    'throw power': '投掷力度',
    'hold to charge and aim - R pulls pin, release throws, RMB bashes, V cancels or drops': '按住蓄力瞄准 · R 拉环，松开投掷，右键近战，V 收回或丢下',
    'BASH': '近战',
    'grenade bash': '手雷近战',
    'in grenades only: bash without cancelling the charge or fuse': '仅限手雷模式：近战打击，不中断蓄力或引信倒计时',
    'in grenades only: tap to strike; keeps throw charge and the live fuse': '仅限手雷模式：点击近战打击，保留蓄力和引信倒计时',
    ...
    'TANK': '坦克',
    'tank Easter eggs': '坦克彩蛋',
    'ON': '开启',
    'OFF': '关闭',
    'Hidden props can reveal tanks': '击打隐藏的小物件可召唤坦克',
    'Hidden props stay ordinary': '隐藏的小物件保持普通物件，不会召唤坦克',
    'Host controls this option': '此选项由房主设置',
    'REVERSE': '倒车',
    'CANNON BLOCKED': '炮口受阻',
    'Cannon impact': '主炮实际落点',
    'HULL {} / AIM {}': '车头 {} / 炮塔 {}',
    'Hull forward {} degrees; turret aim {} degrees': '车头朝向 {} 度；炮塔朝向 {} 度',
    'BRAKE': '刹车',
    'ENTER TANK': '驾驶坦克',
    'EXIT TANK': '离开坦克',
    'PULL OUT': '拉出驾驶员',
    'hold to pull the driver out': '长按拉出驾驶员',
    'leave the tank': '离开坦克',
    'drive the tank': '驾驶坦克',
    'CANNON READY': '主炮就绪',
    'CANNON {} s': '主炮装填 {} 秒',
    ...
    'STOPPED': '已停稳',
    'MOVING': '行驶中',
    'Hold {}: pull driver out': '长按 {}：拉出驾驶员',
    '{}: enter tank': '{}：驾驶坦克',
    '{}: brake - {}: exit': '{} 刹车 · {} 离开坦克',
    '{}: brake before exiting': '{}：先刹停，再离开坦克',
    'SPECTATING {} - TANK {} HP': '正在观战 {} · 坦克耐久 {}',
    'Wait for the tank to stop': '待坦克停稳后可拉出驾驶员',
    'D-pad right': '方向键右',
    'tank: enter / exit; hold beside a stopped tank to pull the driver out': '坦克：上车 / 下车；在停稳的坦克旁长按可拉出驾驶员',
    'tank brake; movement steers and fire shoots the cannon': '坦克刹车；移动控制行驶，攻击发射主炮',
    'tap to enter or exit; hold PULL OUT beside a stopped tank': '点击上车或下车；在停稳的坦克旁长按“拉出驾驶员”',
    'hold to stop the tank; FIRE shoots the cannon': '长按让坦克停稳；点击攻击发射主炮',
